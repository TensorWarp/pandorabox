...
TITLE = "TERRAFORM COMMUNITY SUBMODULES"
VER = "2.3"

PATH_FOLDER = os.getcwd()
SUBMODULE_TERRAFORM = os.path.join(PATH_FOLDER, "module_community.lst")
PATH_MODULES = os.path.join(PATH_FOLDER, "terraform/modules/providers/aws/community")

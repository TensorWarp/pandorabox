                ...
                "containers": [
                    {
                        ...
                        "env": [
                            ...
                            {
                                "name": "AWS_ROLE_ARN",
                                "value": "arn:aws:iam::YOUR_AWS_ACCOUNT:role/cluster-autoscaler-tensorwarp-prod-role"
                            }
                        ],
                        "command": [
                            "./cluster-autoscaler",
                            ...
                            "--node-group-auto-discovery=asg:tag=k8s.io/cluster-autoscaler/enabled,k8s.io/cluster-autoscaler/tensorwarp-prod",
...
kubectl patch ServiceAccount cluster-autoscaler -n kube-system --patch '{"metadata":{"annotations":{"eks.amazonaws.com/role-arn": "arn:aws:iam::YOUR_AWS_ACCOUNT:role/cluster-autoscaler-tensorwarp-prod-role"}}}'

...
variable "kms_key" {
  ...
  default = {
    lab     = "arn:aws:kms:ap-us-west2:YOUR_AWS_ACCOUNT:key/HASH_ID"
    staging = "arn:aws:kms:ap-us-west2:YOUR_AWS_ACCOUNT:key/HASH_ID"
    prod    = "arn:aws:kms:ap-us-west2:YOUR_AWS_ACCOUNT:key/HASH_ID"
  }
}
...
variable "tfstate_bucket" {
  type        = string
  description = "Name of bucket to store tfstate"
  default     = "tensorwarp-terraform-remote-state"
}

variable "tfstate_dynamodb_table" {
  type        = string
  description = "Name of dynamodb table to store tfstate"
  default     = "tensorwarp-terraform-state-lock"
}

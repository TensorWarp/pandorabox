...
variable "kms_key" {
  ...
  default = {
    lab     = "arn:aws:kms:ap-us-west2:YOUR_AWS_ACCOUNT:key/CMK_KEY_HASH"
    staging = "arn:aws:kms:ap-us-west2:YOUR_AWS_ACCOUNT:key/CMK_KEY_HASH"
    prod    = "arn:aws:kms:ap-us-west2:YOUR_AWS_ACCOUNT:key/CMK_KEY_HASH"
  }
}

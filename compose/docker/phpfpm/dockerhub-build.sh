...
# export CI_PROJECT_PATH="tensorwarp"
...
main() {
  # docker_build 8.1 Dockerfile-8.1-fpm alpine tensorwarp/phpfpm
  # docker_build 8.0 Dockerfile-8.0-fpm alpine tensorwarp/phpfpm
  # docker_build 7.4 Dockerfile-7.4-fpm alpine tensorwarp/phpfpm
